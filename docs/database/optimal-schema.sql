-- Optimal Database Schema for AI Private Search Customer Manager
...
CREATE TABLE IF NOT EXISTS customers (
  ...
  customer_code VARCHAR(64) UNIQUE NOT NULL,  -- License key
...
-- ============================================================================
-- LICENSES TABLE
-- Stores subscription licenses with trial and payment status
-- ============================================================================
CREATE TABLE IF NOT EXISTS licenses (
  id INT AUTO_INCREMENT PRIMARY KEY,
  customer_id INT NOT NULL,
  tier TINYINT NOT NULL DEFAULT 1,  -- 1=Standard, 2=Premium, 3=Professional
...
-- ============================================================================
-- DEVICES TABLE
-- Tracks devices registered to each license
-- ============================================================================
...
-- ============================================================================
-- PAYMENTS TABLE
-- Stores payment transactions via PayPal
-- ============================================================================
CREATE TABLE IF NOT EXISTS payments (
  ...
  tier TINYINT NOT NULL,  -- Tier purchased
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Tracks license activation attempts for security
-- ============================================================================
...
-- Stores revoked tokens for security
-- ============================================================================
